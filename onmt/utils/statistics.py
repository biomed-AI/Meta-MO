...
class Statistics(object):
    ...
    * elapsed time
    ...
    def ppl(self):
        """ compute perplexity """
        return math.exp(min(self.loss / self.n_words, 100)) if self.n_words != 0 else 1.0

    def elapsed_time(self):
        """ compute elapsed time """
        return time.time() - self.start_time

    def output(self, epoch, num_epochs, learning_rate, start):
        ...
        t = self.elapsed_time()
        logger.info(
            ("Epoch %d/%d; acc: %6.2f; ppl: %5.2f; xent: %4.2f; " +
    ...
    def log_tensorboard(self, prefix, writer, learning_rate, epoch):
        ...
        writer.add_scalar(prefix + "/lr", learning_rate, epoch)
