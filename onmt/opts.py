...
def model_opts(parser):
    ...
    group.add_argument('-word_vec_size', type=int, default=256,
    ...
    group.add_argument('-enc_rnn_size', type=int, default=256,
                       ...
                       speech-to-text.""")
    group.add_argument('-dec_rnn_size', type=int, default=256,
...
def train_opts(parser):
    ...
    group.add_argument('-save_checkpoint_epochs', type=int, default=1,
    ...
    group.add_argument('-gpu_ranks', default=[0], nargs='+', type=int,
    ...
    group.add_argument('-param_init', type=float, default=0,
    ...
    group.add_argument('-meta_iterations', type=int, default=100)
    group.add_argument('-inner_iterations', type=int, default=2)
    group.add_argument('-meta_lr', type=float, default=0.0005)
    group.add_argument('-meta_dev_task', type=str, default='CHEMBL2147')
    group.add_argument('-meta_test_task', type=str, default='CHEMBL2599')
    group.add_argument('-load_meta_step', type=int, default=0)
    group.add_argument('-data_ratio', type=float, default = 1.0)
    ...
    group.add_argument('-accum_count', type=int, default=4,
    ...
    group.add_argument('-max_generator_batches', type=int, default=32,
                       help="""Maximum batches of words in a sequence to run
                        ...
                        uses more memory.""")
    group.add_argument('-train_epochs', type=int, default=200,
                       help='Training epochs for joint training')
    ...
    group.add_argument('-adam_beta2', type=float, default=0.998,
    ...
    group.add_argument('-decay_method', type=str, default="noam",
                       choices=['noam'], help="Use a custom decay rate.")
    group.add_argument('-warmup_steps', type=int, default=32,
...
def translate_opts(parser):
    ...
    group.add_argument('-max_length', type=int, default=200,
    ...
    group.add_argument('-translate_batch_size', type=int, default=64,
                       help='Batch size')
